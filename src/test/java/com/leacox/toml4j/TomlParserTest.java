...
public class TomlParserTest {
  ...
  public void testStringValueMultipleSpecialCharacters() throws IOException {
    String tomlString =
        "mystring = \"I'm a string. \\\"You can quote me\\\". Tab \\t newline \\n you get it.\"";
  ...
  public void testStringValueCarriageReturnCharacter() throws IOException {
    ...
    assertEquals(
        "This is a string with carriage return: \r", tomlNode.get("mystring").stringValue());
  }
  ...
  public void testStringValueSlashCharacter() throws IOException {
    ...
    assertEquals(
        "This is a string with a slash (optional to escape): /",
        tomlNode.get("mystring").stringValue());
  }
  ...
  public void testStringValueBasicUnicode() throws IOException {
    String tomlString =
        "mystring = \"I'm a string. \\\"You can quote me\\\". Name\\tJos\\u00E9\\nLocation\\tSF.\"";
  ...
  public void testFloatValuePi() throws IOException {
    ...
    assertEquals(
        3.14159265358979323846264338327950288, tomlNode.get("pi").doubleValue(),
